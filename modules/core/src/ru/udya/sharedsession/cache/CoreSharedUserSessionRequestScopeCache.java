...
//
//    @Override
//    public <T extends UserSession> T getUserSessionFromCache(UUID id) {
...
//
//    @Override
//    public void saveInCache(UserSession userSession) {
//        RequestAttributes requestAttributes =
//                RequestContextHolder.getRequestAttributes();
//        if (requestAttributes != null) {
...
//
//    @Override
//    public void removeFromCache(UserSession userSession) {
//        RequestAttributes requestAttributes =
//                RequestContextHolder.getRequestAttributes();
//        if (requestAttributes != null) {
